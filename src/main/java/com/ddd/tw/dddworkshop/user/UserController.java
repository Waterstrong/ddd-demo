...
public class UserController {
    ...
    public void register(@RequestBody RegisterCommand registerField) {
    ...
    public void login(@RequestBody LoginCommand loginField) {
    ...
    public void initPassword(@RequestBody InitPasswordCommand initPasswordField) {
